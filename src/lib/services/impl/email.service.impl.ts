  ...
  async sendOTPEmail(to: string, otpCode: string): Promise<void> {
    ...
    try {
      const mailOptions: SendMailOptions = {
        from: '"Stellar One Holdings" <no-reply@stellarone-holdings.com>',
        to,
        subject: "Your One-Time Password (OTP) for Stellar One Holdings",
    ...
    return `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <div style="background: #ffffff; padding: 28px 24px; border-radius: 16px 16px 0 0; text-align: center; position: relative; overflow: hidden;">
          ...
          <img src="https://stellarone-holdings.com/images/logo-black.png" alt="Stellar One Holdings" style="height: 40px; width: auto; margin: 0;" />
        </div>
        <!-- Content -->
  ...
  async sendPasswordResetEmail(to: string, resetUrl: string): Promise<void> {
    try {
      const mailOptions: SendMailOptions = {
        from: '"Stellar One Holdings" <no-reply@stellarone-holdings.com>',
        to,
        subject: "Password Reset Request for Stellar One Holdings",
    ...
    return `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <div style="background: #ffffff; padding: 32px 24px; border-radius: 0 0 16px 16px;">
          ...
          <p style="color: #52525b; font-size: 16px; line-height: 1.5; margin-bottom: 24px;">
            You requested to reset your password for your Stellar One Holdings account. Click the button below to create a new password. This link will expire in 1 hour.
          </p>
