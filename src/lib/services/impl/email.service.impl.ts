  ...
  async sendOTPEmail(to: string, otpCode: string): Promise<void> {
    ...
    try {
      const mailOptions: SendMailOptions = {
        from: '"Stellar One Holdings" <no-reply@stellaroneholdings.com>',
        to,
    ...
    return `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <div style="background: #ffffff; padding: 28px 24px; border-radius: 16px 16px 0 0; text-align: center; position: relative; overflow: hidden;">
          ...
          <img src="https://stellaroneholdings.com/images/logo-black.png" alt="Stellar One Holdings" style="height: 40px; width: auto; margin: 0;" />
        </div>
        <!-- Content -->
