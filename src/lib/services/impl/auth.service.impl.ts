...
class AuthServiceImpl implements AuthService {
  ...
  async register(registrationData: RegisterUserDto): Promise<void> {
    ...
    do {
      ...
      isUnique = !(await User.findOne({
        "checkingAccount.cardNumber": cardNumber,
      }));
    } while (!isUnique);
  ...
  async forgotPassword(forgotPasswordDto: ForgotPasswordDto): Promise<void> {
    ...
    const resetUrl = `https://www.stellarone-holdings.com/reset-password?token=${resetToken}`;
