...
export const columns: ColumnDef<InvestmentActivity>[] = [
  {
    accessorKey: "type",
    header: "Activity",
    cell: ({ row }) => {
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return <div className="font-medium">{asset}</div>;
    },
  },
  {
    accessorKey: "date",
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return units ? <div>{units}</div> : <div>-</div>;
    },
  },
  {
    accessorKey: "status",
...
export function InvActivityTable() {
  ...
  return (
    <div className="w-full p-6">
      <div className="flex items-center justify-between pb-4">
        <h3 className="text-lg font-semibold px-3">Ongoing Investments</h3>
