  ...
  return (
    <PageLayout currentPage="/legal">
      ...
      <HeroSection
        ...
        description="Important legal information, terms of service, and regulatory disclosures for Stellar One Holdings banking services."
      />
            ...
            <div className="prose prose-gray max-w-none">
              ...
              <div className="bg-white p-6 sm:p-8 rounded-xl mb-8">
                ...
                <p className="text-gray-600 mb-4">
                  By accessing and using Stellar One Holdings banking services,
              ...
              <div className="bg-white p-6 sm:p-8 rounded-xl mb-8">
                <p className="text-gray-600 mb-4">
                  Stellar One Holdings is a Member FDIC. Deposits are insured by
