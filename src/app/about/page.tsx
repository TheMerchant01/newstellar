...
export default function AboutPage() {
  return (
    <PageLayout currentPage="/about">
      {/* Hero Section */}
      <HeroSection
        badgeText="About Stellar One Holdings"
        badgeIcon="🏦"
        title="Banking Built"
      ...
      <CTASection
        ...
        description="Join millions of customers who trust Stellar One Holdings for their financial needs. Discover what makes us different."
